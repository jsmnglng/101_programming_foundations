...
# an incredibly rapid rate. For example, the 100th Fibonacci number is 354,224,848,179,
# 261,915,075 -- that's enormous, especially considering that it takes 6 iterations 
...
# has the number of digits specified as an argument. (The first Fibonacci number has 
# index 1.)
