...
def generate_uuid
  sec_1 = CHARACTERS.sample(8).join
  sec_2 = CHARACTERS.sample(4).join
  sec_3 = CHARACTERS.sample(4).join
  sec_4 = CHARACTERS.sample(4).join
  sec_5 = CHARACTERS.sample(12).join
