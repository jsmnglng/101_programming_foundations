...
# supplied Ben with a method called is_an_ip_number? that detrmines if
# a string is a valid ip address number and asked Ben to use it.
...
# missed a few thing. You're not returning false condition, and you're
# not handing the case that there are more or fewer than 4 components
